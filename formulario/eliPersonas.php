...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form id="form2" name="form1" method="post" action="ctlPersona.php">
            ...
            <table width="417" border="0">
                ...
                <tr>
                    ...
                    <td><input name="persona[nombre]" type="text" id="nombre" size="25" maxlength="25" readonly="yes" value="<?php echo $persona->getNombre(); ?>"  /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="persona[contrasena]" id="contraseña" value="<?php echo $persona->getContrasena(); ?>"/></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
