...
<body>
<p class="bb">
  <object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="1123" height="117">
    ...
    <!--[if !IE]>-->
    <object type="application/x-shockwave-flash" data="imagenes/banner.swf" width="1123" height="117">
      <!--<![endif]-->
      <param name="quality" value="high" />
      <param name="wmode" value="opaque" />
      <param name="swfversion" value="8.0.35.0" />
